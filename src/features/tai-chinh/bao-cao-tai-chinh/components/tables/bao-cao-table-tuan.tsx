...
import { BaoCaoTableTuanMobile } from './mobile/bao-cao-table-tuan-mobile'

interface BaoCaoTableTuanProps {
  data: BaoCaoGroupedByTime[]
}

export function BaoCaoTableTuan({ data }: BaoCaoTableTuanProps) {
      ...
      <div className="max-h-[400px] overflow-y-auto">
        <Table>
          <TableHeader className="sticky top-0 bg-background z-10">
            <TableRow>
              <TableHead className="h-9 text-xs">Tuần</TableHead>
  ...
  return (
    <BaoCaoTableWrapper
      ...
      mobileView={<BaoCaoTableTuanMobile data={data} />}
    >
      {tableContent}
    </BaoCaoTableWrapper>
  )
