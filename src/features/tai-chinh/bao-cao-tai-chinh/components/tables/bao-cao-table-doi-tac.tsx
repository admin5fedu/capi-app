...
import type { BaoCaoGroupedByDoiTac } from '@/types/bao-cao-tai-chinh'
...
import { BaoCaoTableDoiTacMobile } from './mobile/bao-cao-table-doi-tac-mobile'

interface BaoCaoTableDoiTacProps {
  data: BaoCaoGroupedByDoiTac[]
}

export function BaoCaoTableDoiTac({ data }: BaoCaoTableDoiTacProps) {
  ...
  return (
    <BaoCaoTableWrapper
      ...
      mobileView={<BaoCaoTableDoiTacMobile data={data} />}
    >
      {tableContent}
    </BaoCaoTableWrapper>
  )
