...
import type { BaoCaoGroupedByLoaiTien } from '@/types/bao-cao-tai-chinh'
...
import { BaoCaoTableLoaiTienMobile } from './mobile/bao-cao-table-loai-tien-mobile'

interface BaoCaoTableLoaiTienProps {
  data: BaoCaoGroupedByLoaiTien[]
}

export function BaoCaoTableLoaiTien({ data }: BaoCaoTableLoaiTienProps) {
  ...
  return (
    <BaoCaoTableWrapper
      ...
      mobileView={<BaoCaoTableLoaiTienMobile data={data} />}
    >
      {tableContent}
    </BaoCaoTableWrapper>
  )
