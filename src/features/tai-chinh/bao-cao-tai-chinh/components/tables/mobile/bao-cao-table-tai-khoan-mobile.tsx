...
interface BaoCaoTableTaiKhoanMobileProps {
  data: BaoCaoGroupedByTaiKhoan[]
}

export function BaoCaoTableTaiKhoanMobile({ data }: BaoCaoTableTaiKhoanMobileProps) {
    ...
    <div className="space-y-3 p-4">
      {data
        ...
        .map((item) => {
          ...
          return (
            <Card key={item.taiKhoanId}>
              <CardContent className="p-4 space-y-2">
                <div className="flex items-center justify-between">
                  <div className="font-semibold text-base">{item.taiKhoanTen}</div>
