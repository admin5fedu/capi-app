...
interface BaoCaoTableThoiGianMobileProps {
  data: BaoCaoGroupedByTime[]
}

export function BaoCaoTableThoiGianMobile({ data }: BaoCaoTableThoiGianMobileProps) {
          ...
          return (
            <Card key={item.period}>
              <CardContent className="p-4 space-y-2">
                <div className="font-semibold text-base">{item.period}</div>
