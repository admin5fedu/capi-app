...
interface BaoCaoTableDanhMucMobileProps {
  data: BaoCaoGroupedByDanhMuc[]
}

export function BaoCaoTableDanhMucMobile({ data }: BaoCaoTableDanhMucMobileProps) {
    ...
    <div className="space-y-3 p-4">
      {data
        ...
        .map((item) => {
          ...
          return (
            <Card key={item.danhMucId}>
              <CardContent className="p-4 space-y-2">
                <div className="font-semibold text-base">{item.danhMucTen}</div>
