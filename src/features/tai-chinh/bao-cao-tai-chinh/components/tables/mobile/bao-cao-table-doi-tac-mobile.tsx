...
interface BaoCaoTableDoiTacMobileProps {
  data: BaoCaoGroupedByDoiTac[]
}

export function BaoCaoTableDoiTacMobile({ data }: BaoCaoTableDoiTacMobileProps) {
    ...
    <div className="space-y-3 p-4">
      {data
        ...
        .map((item) => {
          ...
          return (
            <Card key={item.doiTacId}>
              <CardContent className="p-4 space-y-2">
                <div className="font-semibold text-base">{item.doiTacTen}</div>
