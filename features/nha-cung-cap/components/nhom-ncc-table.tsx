...
import { Edit, Trash2, FolderTree, FileText } from 'lucide-react';
import { NhomDoiTac } from '../core/types';
import { formatDate } from '../../../shared/utils/format';

interface NhomNCCTableProps {
  data: NhomDoiTac[];
  onEdit: (item: NhomDoiTac) => void;
  onDelete: (item: NhomDoiTac) => void;
}

const NhomNCCTable: React.FC<NhomNCCTableProps> = ({ data, onEdit, onDelete }) => {
  return (
    <Table>
      <TableHeader>
        <TableRow>
          <TableHead className="w-[80px]">ID</TableHead>
          <TableHead>Tên nhóm NCC</TableHead>
